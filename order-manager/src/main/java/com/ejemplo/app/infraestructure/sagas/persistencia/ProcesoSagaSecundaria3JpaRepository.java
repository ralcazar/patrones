...
/** Tabla satélite (SPI {@link com.ejemplo.app.infraestructure.ordermanager.persistencia.MapeadorProceso}) del contexto de la saga secundaria 3. */
public interface ProcesoSagaSecundaria3JpaRepository extends JpaRepository<ProcesoSagaSecundaria3Entity, UUID> {
    ...
    @Query(value = "DELETE FROM proceso_saga_secundaria3 WHERE orden_id IN :ids", nativeQuery = true)
