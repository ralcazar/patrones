 ...
 * soporte (8, 11, 14 y 17h) barre las órdenes con "abrir ticket pendiente" y
...
public class PlanificadorTicketsSoporte {
    ...
    public void ejecutar() {
        int ordenesTocadas = tickets.abrirTicketsPendientes();
        if (ordenesTocadas > 0) {
            log.info("Barrido de tickets: abierto 1 ticket que cubre {} órdenes", ordenesTocadas);
        }
    }
}
