 ...
 */
@AggregateRoot
public final class SagaSecundaria3Root extends SagaRoot<EstadoSagaSecundaria3> {
    ...
    public static SagaSecundaria3Root crear(SagaId id, ContextoArranque.ArranqueSecundaria3 ctx) {
        return new SagaSecundaria3Root(id, ctx.externalId(), ctx.refPaso7(), EstadoSagaSecundaria3.INICIAL);
    }

    /** Para el adaptador de persistencia. */
    public static SagaSecundaria3Root rehidratar(SagaId id, ExternalId externalId, RefPaso7 refPaso7,
            RefEjecucion refEjecucion, EstadoSagaSecundaria3 estado, List<AuditoriaIntervencion> auditoria) {
        return new SagaSecundaria3Root(id, externalId, refPaso7, refEjecucion, estado, auditoria);
    }
